            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl p-10 shadow-lg border border-gray-100 dark:border-gray-700 transform hover:-translate-y-2 transition-transform duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                {language === "en"
                  ...
                  : "أن نكون المعيار الأمنى للمطورين المتكاملين الذين يبنون تطبيقات React جاهزة للإنتاج. نعرض كيفية دمج الخدمات الخلفية المعقدة بشكل مثالي مع تصميمات الواجهات الأمامية الجميلة."}
              </p>
            </div>
          </div>
        </div>
